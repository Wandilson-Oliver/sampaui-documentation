...
@section('content')
    ...
    <section class="grid gap-5 lg:grid-cols-2 xl:grid-cols-4">
        @foreach ([
            ...
            [
                'title' => 'Dashboard',
                'copy' => 'Dashboard imobiliário completo com Sidebar, métricas, ApexCharts, tabelas e Blade copiável.',
                'icon' => 'grid',
                'route' => 'examples.dashboard',
            ],
            [
                'title' => 'Cadastro de usuário',
                'copy' => 'Formulário administrativo com preview de foto, estados de validação e bindings Livewire.',
                'icon' => 'person-plus',
