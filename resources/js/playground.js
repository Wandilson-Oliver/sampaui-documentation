export function registerPlayground(Alpine) {
    Alpine.data('playgroundShell', (templatesData = {}, config = {}) => ({
        ...
        autocompleteList: [
            ...
            { label: '<x-sampaui::card>', type: 'sampaui', desc: 'Card container oficial', icon: 'bi-card-heading', snippet: '<x-sampaui::card title="Título do Card" description="Descrição">\n  <p class="text-sm text-slate-600">Conteúdo do card.</p>\n</x-sampaui::card>' },
            { label: '<x-sampaui::button>', type: 'sampaui', desc: 'Botão com variantes e ícone', icon: 'bi-hand-index-thumb', snippet: '<x-sampaui::button variant="primary" label="Salvar Alterações" icon="check-lg" />' },
            { label: '<x-sampaui::input>', type: 'sampaui', desc: 'Campo de texto com label e erro', icon: 'bi-input-cursor-text', snippet: '<x-sampaui::input name="nome" label="Nome Completo" placeholder="Digite seu nome..." required />' },
            { label: '<x-sampaui::badge>', type: 'sampaui', desc: 'Badge indicativo colorido', icon: 'bi-patch-check', snippet: '<x-sampaui::badge variant="primary" label="Ativo" icon="circle-fill" />' },
            { label: '<x-sampaui::alert>', type: 'sampaui', desc: 'Alerta informativo com ícone', icon: 'bi-exclamation-triangle', snippet: '<x-sampaui::alert variant="info" title="Atenção" icon="info-circle">\n  Mensagem descritiva do alerta.\n</x-sampaui::alert>' },
            { label: '<x-sampaui::modal>', type: 'sampaui', desc: 'Janela modal interativa', icon: 'bi-window-stack', snippet: '<x-sampaui::modal id="modal-demo" title="Título do Modal">\n  <p>Conteúdo da janela modal.</p>\n  <x-slot:actions>\n    <x-sampaui::button variant="primary" label="Confirmar" />\n  </x-slot:actions>\n</x-sampaui::modal>' },
            { label: '<x-sampaui::drawer>', type: 'sampaui', desc: 'Gaveta / painel lateral deslizante', icon: 'bi-layout-sidebar-inset-reverse', snippet: '<x-sampaui::drawer id="drawer-demo" position="right" title="Painel Lateral">\n  <p>Conteúdo do drawer.</p>\n</x-sampaui::drawer>' },
            { label: '<x-sampaui::avatar>', type: 'sampaui', desc: 'Avatar com imagem ou iniciais', icon: 'bi-person-circle', snippet: '<x-sampaui::avatar name="Ana Clara" size="md" />' },
            { label: '<x-sampaui::select>', type: 'sampaui', desc: 'Select com opções', icon: 'bi-menu-button-wide', snippet: '<x-sampaui::select name="categoria" label="Categoria">\n  <option value="1">Opção 1</option>\n  <option value="2">Opção 2</option>\n</x-sampaui::select>' },
            { label: '<x-sampaui::checkbox>', type: 'sampaui', desc: 'Checkbox com label', icon: 'bi-check-square', snippet: '<x-sampaui::checkbox name="termos" label="Aceito os termos de serviço" />' },
            { label: '<x-sampaui::radio>', type: 'sampaui', desc: 'Radio button selecionável', icon: 'bi-ui-radios', snippet: '<x-sampaui::radio name="opcao" label="Opção Principal" value="1" />' },
            { label: '<x-sampaui::textarea>', type: 'sampaui', desc: 'Campo de texto multilinha', icon: 'bi-textarea-resize', snippet: '<x-sampaui::textarea name="obs" label="Observações" rows="4" placeholder="Escreva aqui..." />' },
            { label: '<x-sampaui::tooltip>', type: 'sampaui', desc: 'Dica flutuante explicativa', icon: 'bi-chat-square-text', snippet: '<x-sampaui::tooltip text="Dica explicativa">\n  <button class="text-xs text-primary font-bold">Ajuda</button>\n</x-sampaui::tooltip>' },
            { label: '<x-sampaui::dropdown>', type: 'sampaui', desc: 'Menu dropdown de ações', icon: 'bi-menu-app', snippet: '<x-sampaui::dropdown label="Opções">\n  <x-sampaui::dropdown-item label="Editar" icon="pencil" />\n  <x-sampaui::dropdown-item label="Excluir" icon="trash" variant="danger" />\n</x-sampaui::dropdown>' },
            { label: '<x-sampaui::tabs>', type: 'sampaui', desc: 'Abas de navegação dinâmica', icon: 'bi-segmented-nav', snippet: '<x-sampaui::tabs :tabs="[\'Geral\', \'Configurações\']">\n  <x-slot:geral>\n    <p>Conteúdo da aba Geral.</p>\n  </x-slot:geral>\n  <x-slot:configuracoes>\n    <p>Conteúdo da aba Configurações.</p>\n  </x-slot:configuracoes>\n</x-sampaui::tabs>' },
            { label: '<x-sampaui::table>', type: 'sampaui', desc: 'Tabela com cabeçalhos estilizados', icon: 'bi-table', snippet: '<x-sampaui::table :headers="[\'Nome\', \'Email\', \'Ações\']">\n  <tr>\n    <td class="p-3">Carlos Silva</td>\n    <td class="p-3">carlos@email.com</td>\n    <td class="p-3"><x-sampaui::button size="sm" label="Visualizar" /></td>\n  </tr>\n</x-sampaui::table>' },
            { label: '<x-sampaui::stat-card>', type: 'sampaui', desc: 'Card de métricas e KPIs', icon: 'bi-graph-up-arrow', snippet: '<x-sampaui::stat-card title="Receita Mensal" value="R$ 48.900" icon="currency-dollar" trend="+18.4%" />' },
            { label: '<x-sampaui::spinner>', type: 'sampaui', desc: 'Spinner de carregamento animado', icon: 'bi-arrow-repeat', snippet: '<x-sampaui::spinner size="md" color="primary" />' },
            { label: '<x-sampaui::progress>', type: 'sampaui', desc: 'Barra de progresso percentual', icon: 'bi-bar-chart-steps', snippet: '<x-sampaui::progress value="75" max="100" variant="primary" />' },
            { label: '<x-slot:actions>', type: 'sampaui', desc: 'Slot de ações para componentes', icon: 'bi-layout-text-window', snippet: '<x-slot:actions>\n  <x-sampaui::button size="sm" variant="primary" label="Confirmar" />\n</x-slot:actions>' },
            { label: '<x-slot:footer>', type: 'sampaui', desc: 'Slot de rodapé para componentes', icon: 'bi-layout-text-window-reverse', snippet: '<x-slot:footer>\n  <p class="text-xs text-slate-500">Última atualização agora</p>\n</x-slot:footer>' },
        ...
        init() {
            const saved = localStorage.getItem('sampaui_playground_state_v7') || localStorage.getItem('sampaui_playground_state_v6');
            if (saved) {
                try {
        ...
        saveState() {
            ...
            localStorage.setItem('sampaui_playground_state_v7', JSON.stringify(state));
        },
